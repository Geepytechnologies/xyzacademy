  ...
  return (
    <div className='relative h-[400px] w-[100%]'>
      ...
      <div className='absolute top-0 w-[100%] sm:w-[50%] m-[3px] h-[100%] flex flex-col justify-center items-center '>
        ...
        <div onClick={()=>{router.push('/services')}} className='bg-[hsl(34,100%,47%)] w-[50%] sm:w-[40%] md:w-[50%] text-center cursor-pointer rounded-xl border border-white mt-[15px] p-[10px] font-[600]'>Register With Us</div>
      </div>
    </div>
