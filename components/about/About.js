    ...
    <div className='about'>
        <div className='aboutoverlay'>
          <div className='w-[100%] sm:w-[50%] m-[3px] h-[100%] flex flex-col justify-center items-center '>
            <h1 data-aos="fade-down" className='text-[#f08800] w-[80%]  pl-[5px] font-[700] text-[30px] font-danc '>The best way to master the financial market and make unfair profits from it.</h1>
            ...
            <div className='bg-[hsl(34,100%,47%)] w-[40%] sm:w-[40%] md:w-[50%] text-center rounded-xl border border-white mt-[15px] p-[10px] font-[600]'>Register With Us</div>
          </div>
        </div>
    </div>
  )
