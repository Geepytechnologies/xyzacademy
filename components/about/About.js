  ...
  return (
    <div className='relative h-[auto] sm:h-[400px] w-[100%]'>
      ...
      <div className='absolute py-[10px] top-0 w-[100%] sm:w-[80%] h-[100%] flex flex-col justify-center items-center '>
        <h1 data-aos="fade-down" className='text-[#f08800] w-[80%]  pl-[5px] font-[800] sm:text-[30px] text-[25px] font-danc '>The best way to master the financial market and make unfair profits from it.</h1>
