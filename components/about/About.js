  ...
  return (
    <div className='relative h-[auto] sm:h-[400px] w-[100%]'>
      ...
      <div className='absolute py-[10px] top-0 w-[100%] sm:w-[80%] h-[100%] flex flex-col justify-center items-center '>
        ...
        <div onClick={()=>{router.push('/')}} className='bg-[hsl(34,100%,47%)] w-[50%] sm:w-[40%] md:w-[50%] text-center cursor-pointer rounded-xl border border-white mt-[15px] p-[10px] font-[600]'>Register With Us</div>
      </div>
    </div>
