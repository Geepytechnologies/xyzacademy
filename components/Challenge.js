...
export default function Challenge() {
  ...
  return (
    <div onClick={()=>{router.push('/paychallenge')}}   data-aos='zoom-in-right' className='mb-[40px] items-center justify-center flex flex-col'>
        <div className='w-[90%] pl-[5px] mb-[10px] cursor-pointer '>
