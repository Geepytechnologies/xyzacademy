...
export default function Index() {
    const Article = () => (
        <div className='p-[20px]'>
            ...
            <div className='w-[100%] h-[400px] md:w-[50%] md:h-[500px] mb-[10px] relative'>
            <Image src={'/article1.png'} layout='fill' objectFit='contain' objectPosition={'center'} />
            </div>
            ...
            <div className='w-[300px] md:w-[500px] h-[300px] relative '>
                <Image src={'/article101.png'} layout='fill' objectFit='contain' objectPosition={'center'} />
            </div>
